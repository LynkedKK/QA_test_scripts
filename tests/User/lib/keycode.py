...
# Key code constant: Close media key. May be used to stop a CD tray, for example.
...
# Key code constant: '*' key (for multiplication).
...
KEYCODE_ASSIST=219
# Key code constant: Brightness Down key. Adjusts the screen brighs down.
