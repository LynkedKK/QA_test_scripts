...
def test_happyflow_1_chrome_click_acept_and_continue():
  ...
  ele_link = browser.find_element_by_id('test_link')
  # check_first_time_landing = first_time_landing.CheckPage(browser)
  # check_first_time_landing.checkAcceptAndContinueButtonExist()
